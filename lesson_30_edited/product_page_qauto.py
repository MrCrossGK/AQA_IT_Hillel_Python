from lesson_30_edited.base_page_qauto import BasePageQAuto
from lesson_30_edited.locators_qauto import LocatorsQAuto
import allure
...
class ProductPageQAuto(BasePageQAuto):
    ...
    @allure.step('Clicking "Registration" button')
    ...
    def fill_registration_form(self, name, last_name, email, password):
        with allure.step('Filling User name, last name, email, password and re-password fields'):
            self._modal(locator=LocatorsQAuto.login_modal_loc, timeout=10, message='Cant find modal!')
    ...
    @allure.step('Clicking "Register" button')
